...
;=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-;
do_test:
        mov     si,crt6845_3d4_a+16*0           ;table offset
        call    do_out
        call    wait_key

        mov     si,crt6845_3d4_a+16*1           ;table offset
        call    do_out
        call    wait_key

        mov     si,crt6845_3d4_a+16*2           ;table offset
        call    do_out
        call    wait_key

        mov     si,crt6845_3d4_a+16*3           ;table offset
        call    do_out
        call    wait_key
